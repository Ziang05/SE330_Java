...
CREATE TABLE IF NOT EXISTS patients (
    ...
    CONSTRAINT uk_patients_cccd UNIQUE (cccd),
    INDEX idx_patients_cccd (cccd),
...
CREATE TABLE IF NOT EXISTS appointments (
    ...
    appt_datetime DATETIME(6) NOT NULL,
    ...
    INDEX idx_appointments_appt_datetime (appt_datetime)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS medicines (
    ...
    insurance_covered BIT(1) NOT NULL DEFAULT b'0',
    active BIT(1) NOT NULL DEFAULT b'1',
    created_at DATETIME(6) NOT NULL,
    updated_at DATETIME(6) NOT NULL,
    INDEX idx_medicines_medicine_name (medicine_name),
...
CREATE TABLE IF NOT EXISTS prescription_items (
    ...
    dosage VARCHAR(120),
    instructions TEXT,
    unit_price_at_time DECIMAL(12, 2) NOT NULL DEFAULT 0,
    created_at DATETIME(6) NOT NULL,
    updated_at DATETIME(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS lab_tests (
    ...
    created_at DATETIME(6) NOT NULL,
    updated_at DATETIME(6) NOT NULL,
    CONSTRAINT fk_lab_tests_medical_record FOREIGN KEY (medical_record_id) REFERENCES medical_records (id),
    CONSTRAINT fk_lab_tests_ordered_by FOREIGN KEY (ordered_by) REFERENCES doctors (id),
    INDEX idx_lab_tests_medical_record_id (medical_record_id),
    INDEX idx_lab_tests_ordered_by (ordered_by),
    INDEX idx_lab_tests_test_date (test_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    medicine_fee DECIMAL(14, 2) DEFAULT 0,
    lab_fee DECIMAL(14, 2) DEFAULT 0,
    ...
    created_at DATETIME(6) NOT NULL,
    updated_at DATETIME(6) NOT NULL,
    CONSTRAINT uk_invoices_medical_record UNIQUE (medical_record_id),
    CONSTRAINT fk_invoices_medical_record FOREIGN KEY (medical_record_id) REFERENCES medical_records (id),
...
CREATE TABLE IF NOT EXISTS users (
    ...
    INDEX idx_users_doctor_id (doctor_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
